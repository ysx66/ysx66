...
# 后台IP设置
export Ipv4_ipaddr="192.168.71.4"            # 修改openwrt后台地址(填0为关闭)
...
# 旁路由选项
export Gateway_Settings="192.168.71.1"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
...
export amlogic_kernel="5.15.100"
export auto_kernel="true"
export rootfs_size="600"
